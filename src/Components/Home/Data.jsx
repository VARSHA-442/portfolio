...
const Data = () => {
  return (
   <div className="home__data">
    <h1 className="home__title">K.Varsha
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">"I am a third-year student passionate about learning and growing in DSA, Web Development, and AI/ML."</p>
